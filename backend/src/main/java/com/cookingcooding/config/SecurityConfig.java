    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/blog/posts", "/api/blog/posts/*").permitAll()
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/blog/posts/*/comments").permitAll()
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/blog/posts/*/comments").permitAll()
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/blog/comments/*").permitAll()
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/blog/comments/*").permitAll()
